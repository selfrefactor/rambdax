...
type ReplaceReturnType<T, TNewReturn> = (
  ...a: ArgumentTypes<T>
) => TNewReturn
...
export function change<T>(origin: object, path: string, changeData: any): T
...
export function defaultToStrict<T>(fallback: T, ...inputs: T[]): T
...
export function includesType(targetType: RambdaTypes, list: any[]): boolean

export function isFalsy(input: any): boolean
export function isType(targetType: RambdaTypes, input: any): boolean

export function isPromise(maybePromiseOrAsync: any): boolean

export function isFunction(maybePromiseFunctionOrAsync: any): boolean
...
export function mapAsync<T>(
  fn: AsyncWithProp<any>
): (obj: object) => Promise<T[]>

export function mapFastAsync<T>(
  fn: AsyncWithMap<any>,
  list: any[]
): Promise<T[]>
export function mapFastAsync<T>(
...
export function mapAsyncLimit<T, U>(
  iterable: (x: T) => Promise<U>,
  limit: number,
  list: T[]
): Promise<U[]>
export function mapAsyncLimit<T, U>(
...
export function partition<T>(rule: Predicatex<T>, input: T[]): [T[], T[]]
export function partition<T>(
  rule: Predicatex<T>
): (input: T[]) => [T[], T[]]
...
export function produce<T>(conditions: any, input: any): T
export function produce<T>(conditions: any): (input: any) => T

export function promiseAllObject<T>(input: ObjectWithPromises): Promise<T>
...
export function sortObject<T>(
  predicate: SortObjectPredicate<T>
): (obj: {[key: string]: T}) => {[keyOutput: string]: T}
...
export function tryCatch<T>(fn: any, fallback: any): Async<T> | T
...
export function cond(
  fns: Array<[Pred, (...a: readonly any[]) => any]>
): (...a: readonly any[]) => any
export function cond<A, B>(
  fns: Array<[SafePred<A>, (...a: readonly A[]) => B]>
): (...a: readonly A[]) => B
...
export function defaultTo<T>(
  defaultValue: T
): (...inputArguments: Array<T | null | undefined>) => T
export function defaultTo<T>(
  defaultValue: T,
  ...inputArguments: Array<T | null | undefined>
): T
export function defaultTo<T, U>(
  defaultValue: T | U,
  ...inputArguments: Array<T | U | null | undefined>
): T | U
...
export function filter<T>(
  filterFn: FilterFunctionArray<T>
): (x: T[]) => T[]
...
export function fromPairs<V>(
  pairs: Array<KeyValuePair<string, V>>
): {[index: string]: V}
export function fromPairs<V>(
  pairs: Array<KeyValuePair<number, V>>
): {[index: number]: V}
...
export function groupBy<T>(
  fn: (a: T) => string
): (list: ReadonlyArray<T>) => {[index: string]: T[]}
...
export function includes(
  valueToFind: string
): (input: ReadonlyArray<string> | string) => boolean
...
export function indexBy<T>(
  condition: (a: T) => string
): (arr: ReadonlyArray<T>) => {[key: string]: T}
export function indexBy<T>(
  condition: string
): (arr: ReadonlyArray<T>) => {[key: string]: T}
...
export function paths<Input, T>(
  pathsToSearch: Array<string | string[]>,
  obj: Input
): Array<T | undefined>
...
export function paths<T>(
  pathsToSearch: Array<string | string[]>
): (obj: any) => Array<T | undefined>
export function paths<Input, T>(
  pathsToSearch: Array<string | string[]>
): (obj: Input) => Array<T | undefined>
...
export function pluck<P extends string>(
  property: P
): <T>(arr: ReadonlyArray<Record<P, T>>) => T[]
...
export function zip<K>(
  list1: ReadonlyArray<K>
): <V>(list2: ReadonlyArray<V>) => Array<KeyValuePair<K, V>>
