import Rambda, { any, compose, contains, curry, equals, filter, last, length, map, merge, omit, range, replace, sort, split, take, test, toLower, type } from 'rambda';
...
var isType = isType$1;
Object.keys(Rambda).map(function (method) {
  exports[method] = Rambda[method];
});

export { DELAY, isArray, isObject, isString, isType, compact, composeAsync, debounce, delay, evolve$1 as evolve, ifElseAsync, intersection, isPromiseLike, isValid, mapAsync, mapFastAsync, memoize, mergeAll, omitBy, once, pickBy, produce, random, rangeBy, renameProps, resolve, resolveSecure, shuffle, tapAsync, throttle, when, where };
